...
int main(){
	...
	auto rkLVOdeRK57FC = RKAlgorithm<ODE>(rkIntegratorRK57FC, 0, {0.5, 0.5}, 0.05,		100 * n);
	auto rkLVOdeRK68S = RKAlgorithm<ODE>(rkIntegratorRK68S,   0, {1, 1}, 0.005, 	2 * n);
	auto rkLVOdeRK56 = RKAlgorithm<ODE>(rkIntegratorRK56,     0, {1, 1}, 0.005, 	5 * n);
	auto rkLVOdeRK58 = RKAlgorithm<ODE>(rkIntegratorRK58,     0, {1, 1}, 0.001, 	10 * n);
